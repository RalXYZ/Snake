...
color raven = { 0x201c19, 0x9d9893, { 0x030067, 0x376fff, 0x37c0ff, 0x2ac264, 0x86c216, 0xd17524, 0x931941 } };
color nightRain = { 0x201c19, 0x705f52, {0xd9baa2} };
color plumage = { 0xffefdd, 0x00bdd4, {0xc0ac6e} };

//int ravenSnake[] = { 0x030067, 0x376fff, 0x37c0ff, 0x2ac264, 0x86c216, 0xd17524, 0x931941 };
/*Designed by Sunflower*/

color theme[] = { nightClub, cangSong, hoopoe, redBean, bluebird, rose, halloween, panda, raven, nightRain };
